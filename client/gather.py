...
class Monitor:
    ...
    def initialize_database(self):
        ...
        cursor.execute('CREATE TABLE IF NOT EXISTS recordings(timestamp INTEGER, data TEXT)')
    ...
    def add_recording(self, json):
        print('adding recording', json)
